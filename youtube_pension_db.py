...
# ────────────────────────────────────────────────────────────────────
# 테마 태그 (다중 레이블 — 한 영상에 여러 테마 동시 부여 가능)
# ────────────────────────────────────────────────────────────────────
THEME_KEYWORDS = {
    "절세혜택/전략": [
        "세액공제", "과세이연", "절세", "분리과세", "저율과세", "연금소득세",
        "세금", "13월의 월급", "연말정산", "세제혜택", "비과세", "절세전략",
        "세금혜택", "세금 아끼", "세금 줄이", "절세계좌", "ISA", "납입한도",
        "한도 확대", "한도 증액",
    ],
    "연금운용/투자전략": [
        "연금ETF", "연금 ETF", "TDF", "연금 포트폴리오", "연금 운용",
        "연금 투자", "리밸런싱", "자산배분", "디폴트옵션", "사전지정운용",
        "수익률", "운용전략", "포트폴리오", "적립식", "장기투자",
        "ETF 추천", "펀드", "채권", "주식 비중", "투자전략",
    ],
    "연금제도소개": [
        "연금이란", "3층연금", "3층 연금", "국민연금", "연금제도", "연금 종류",
        "연금 구조", "공적연금", "사적연금", "연금 기초", "연금 개념",
    ...
    "상품소개": [
        "ETF 소개", "펀드 소개", "상품 소개", "상품소개", "신상품", "출시",
        "TIGER", "KODEX", "ACE", "ARIRANG", "HANARO",
        "연금저축보험", "연금보험", "변액연금", "즉시연금",
        "MMF", "채권형", "혼합형", "주식형", "TDF",
        "계좌 개설", "계좌개설", "오픈",
    ],
    "연금수령/인출전략": [
        "연금수령", "연금 수령", "연금개시", "인출", "수령방식", "수령 순서",
        "연금 인출", "월 배당", "현금흐름", "연금화",
        "수령 나이", "수령 시기", "수령 방법", "55세", "연금 개시",
        "인출 순서", "인출 전략",
    ],
    "노후설계/은퇴준비": [
        "노후", "은퇴", "노후자금", "은퇴설계", "노후준비", "은퇴준비",
        "노후 대비", "은퇴자금", "노후 생활비", "파이어족", "FIRE",
        "노후 계획", "은퇴 후", "노후 월급", "노후 소득", "정년",
    ],
    "글로벌/해외투자": [
        "해외주식", "미국주식", "글로벌", "S&P", "나스닥", "환헤지", "환노출",
        "해외 ETF", "미국 ETF", "선진국", "신흥국", "달러", "SP500",
        "해외펀드", "미국채",
    ],
    "제도/정책변화": [
        "세법개정", "납입한도", "한도 확대", "한도 증액", "제도 변경",
        "정책", "개정", "법 개정", "퇴직연금 개혁", "연금개혁",
        "세법 개정", "제도개편",
    ],
    "IRP/퇴직연금": [
        "IRP", "퇴직연금", "DC형", "DB형", "확정기여", "확정급여",
        "퇴직금", "퇴직급여", "개인형퇴직연금", "퇴직연금 운용",
    ],
    "연금저축/ISA": [
        "연금저축", "연금저축펀드", "연금저축계좌", "연저펀", "연금저축보험",
        "ISA", "중개형ISA", "ISA계좌",
...
def get_themes(text: str) -> str:
    """매칭된 모든 테마를 '|' 구분 문자열로 반환."""
    matched = [label for label, kws in THEME_KEYWORDS.items() if _count_hits(text, kws) > 0]
    return " | ".join(matched) if matched else "미분류"
