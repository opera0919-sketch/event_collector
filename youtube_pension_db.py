...
# ────────────────────────────────────────────────────────────────────
# 테마 태그 (우선순위 기반 단일 레이블 — 순서대로 첫 매칭 테마 반환)
# ────────────────────────────────────────────────────────────────────
THEME_PRIORITY = [
    # 1. 중도인출 / 중도해지
    ("중도인출/중도해지", [
        "중도인출", "중도 인출", "중도해지", "중도 해지",
        "해지환급금", "해지 불이익", "해지하면", "해지 시",
        "조기인출", "조기 인출", "조기해지", "조기 해지",
        "기타소득세", "16.5", "페널티", "불이익",
        "세금 폭탄", "인출 불이익", "해지 손해",
    ]),
    # 2. 연금인출 (추가)
    ("연금인출", [
        "연금인출", "연금 인출", "인출 전략", "인출 방법", "인출 순서",
        "인출 시기", "인출 방식", "분할 인출", "부분 인출",
        "인출 금액", "얼마 인출", "인출액",
    ]),
    # 3. 연금수령
    ("연금수령", [
        "연금수령", "연금 수령", "수령 방법", "수령 시기", "수령 순서",
        "수령방식", "수령 금액", "수령 나이", "수령 개시",
        "연금 받기", "연금 받는", "연금 개시", "연금개시",
        "연금화", "월 연금", "종신연금", "확정연금",
        "현금흐름", "월 배당", "55세 이후", "연금소득",
    ]),
    # 4. 연금운용
    ("연금운용", [
        "연금ETF", "연금 ETF", "TDF", "연금 포트폴리오", "연금 운용",
        "연금 투자", "리밸런싱", "자산배분", "디폴트옵션", "사전지정운용",
        "수익률", "운용전략", "포트폴리오", "투자전략", "장기투자",
        "ETF 추천", "펀드 추천", "주식 비중", "채권 비중",
        "연금계좌 운용", "수익률 높이", "적립식 투자",
    ]),
    # 5. 연금납입
    ("연금납입", [
        "납입", "적립", "연금 납입", "납입 한도", "납입한도",
        "납입 금액", "얼마 넣", "얼마나 넣", "최대 납입", "추가납입",
        "자동이체", "월 얼마", "한도 확대", "한도 증액",
        "연금저축 납입", "IRP 납입", "세액공제 한도",
        "300만원", "900만원", "1800만원",
    ]),
    # 6. 연금세제
    ("연금세제", [
        "세액공제", "과세이연", "절세", "분리과세", "저율과세", "연금소득세",
        "세금", "13월의 월급", "연말정산", "세제혜택", "비과세", "절세전략",
        "세금혜택", "세금 아끼", "세금 줄이", "절세계좌",
        "종합소득세", "건강보험료 절감", "절세 방법", "세금 혜택",
        "ISA", "세제 개편",
    ]),
    # 7. 연금제도
    ("연금제도", [
        "연금이란", "3층연금", "3층 연금", "국민연금", "연금제도", "연금 종류",
        "연금 구조", "공적연금", "사적연금", "연금 기초", "연금 개념",
        "연금 설명", "연금 이해", "연금 입문", "연금 처음", "연금 시작",
        "IRP란", "연금저축이란", "퇴직연금이란", "DC형이란", "DB형이란",
        "연금 소개", "연금 비교", "연금 제도", "연금 정보",
    ]),

    # ── 이하 '기타' 세부 분류 (7대 주요 테마 미해당 시) ──────────────

    # 기타 (글로벌/해외주식)
    ("기타 (글로벌/해외주식)", [
        "글로벌 슈퍼스탁", "글로벌 주식삼국지", "글로벌 특집",
        "해외주식", "미국주식", "중국주식", "일본주식",
        "해외 ETF", "해외펀드", "해외 직구",
        "TSLA", "NVDA", "AAPL", "MSFT", "AMZN", "GOOG",
        "나스닥100", "S&P500", "SP500",
    ]),

    # 기타 (경제/시장전망)
    ("기타 (경제/시장전망)", [
        "시장 전망", "글로벌 시장", "경제 전망", "글로벌 이슈",
        "인플레이션", "금리인상", "금리 인상", "금리 인하",
        "환율", "물가상승", "경기침체", "마켓", "이슈 체크",
        "빅사이클", "경제위기", "주식시장 전망",
    ]),

    # 기타 (부동산)
    ("기타 (부동산)", [
        "부동산", "아파트", "청약", "재개발", "재건축", "리츠",
        "꼬마빌딩", "오피스텔", "주택", "임대", "분양",
        "REITs", "부동산 투자", "알.부.자",
    ]),
    ...
    # 기타 (ETF/펀드분석)
    ("기타 (ETF/펀드분석)", [
        "언박싱", "이럴 때 이런 상품", "리서치 Report",
        "테마픽", "슈퍼스탁 ZOOM IN", "ETF 분석",
        "채권형 펀드", "인컴형", "리서치",
    ]),
...
def get_theme(text: str) -> str:
    """우선순위 순서로 첫 번째 매칭 테마를 반환 (단일 레이블)."""
